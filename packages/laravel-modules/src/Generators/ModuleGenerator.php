...
class ModuleGenerator extends Generator
{
    ...
    public function generateResources()
    {
        ...
        if (GenerateConfigReader::read('helper')->generate() === true) {
            $this->console->call('module:make-helper', [
                'module' => $this->getName(),
            ]);
        }

        if (GenerateConfigReader::read('support')->generate() === true) {
            $this->console->call('module:make-support', [
                'module' => $this->getName(),
            ]);
        }
