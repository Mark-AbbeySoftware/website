...
class DB2Grammar extends Grammar
{
    ...
    public function compilePrimary(Blueprint $blueprint, Fluent $command)
    {
        ...
        // No use in having the schema name in the name of the Primary constraint
    ...
    public function compileUnique(Blueprint $blueprint, Fluent $command)
    {
        ...
        // No use in having the schema name in the Unique constraint name
        $schemaTable = explode('.', $table);
    ...
    public function compileIndex(Blueprint $blueprint, Fluent $command)
    {
        ...
        // No use in having the schema name in the Index constraint name
        $schemaTable = explode('.', $table);
    ...
    public function compileDropForeign(Blueprint $blueprint, Fluent $command)
    {
        ...
        // No use in having the schema name in the Index constraint foreign
        $schemaTable = explode('.', $table);
    ...
    protected function typeBoolean(Fluent $column)
    {
        ...
        return sprintf($definition, $column->type, $column->prefix, $column->name, $column->name,
